        ...
        if (mpAtlas->KeyFramesInMap() > 2)
        {
          if (mbInertial && mpCurrentKeyFrame->GetMap()->isImuInitialized())
          {
            ...
            if (!mpCurrentKeyFrame->GetMap()->GetIniertialBA2())
            {
              ...
              //     << endl; unique_lock<mutex> lock(mMutexReset);
    ...
    for (int ikp = 0; ikp < nmatches; ikp++)
    {
      ...
      const cv::KeyPoint& kp1 =
          (mpCurrentKeyFrame->NLeft == -1) ?
              ...
              (idx1 < mpCurrentKeyFrame->NLeft + mpCurrentKeyFrame->NRight) ?
              mpCurrentKeyFrame->mvKeysRight[idx1 - mpCurrentKeyFrame->NLeft] :
              (idx1 < mpCurrentKeyFrame->NLeft + mpCurrentKeyFrame->NRight + mpCurrentKeyFrame->NSideLeft) ?
              mpCurrentKeyFrame->mvKeysSideLeft[idx1 - mpCurrentKeyFrame->NLeft - mpCurrentKeyFrame->NRight] :
              mpCurrentKeyFrame->mvKeysSideRight[idx1 - mpCurrentKeyFrame->NLeft - mpCurrentKeyFrame->NRight -
                                                 mpCurrentKeyFrame->NSideLeft];
      ...
      int cameraId1 =
          (mpCurrentKeyFrame->NLeft == -1) ?
              ...
              (idx1 < mpCurrentKeyFrame->NLeft + mpCurrentKeyFrame->NRight) ?
              1 :
              (idx1 < mpCurrentKeyFrame->NLeft + mpCurrentKeyFrame->NRight + mpCurrentKeyFrame->NSideLeft) ? 2 : 3;
      ...
      int cameraId2 =
          (pKF2->NLeft == -1) ?
              ...
              (idx2 < pKF2->NLeft) ?
              0 :
              (idx2 < pKF2->NLeft + pKF2->NRight) ? 1 : (idx2 < pKF2->NLeft + pKF2->NRight + pKF2->NSideLeft) ? 2 : 3;
        ...
        if (!pMP->isBad())
        {
          ...
          if (pMP->Observations() > thObs)
          {
            const int& scaleLevel = (pKF->NLeft == -1) ?
                                        ...
                                        (i < pKF->NLeft) ?
                                        pKF->mvKeys[i].octave :
                                        (i < pKF->NLeft + pKF->NRight) ?
                                        pKF->mvKeysRight[i - pKF->NLeft].octave :
                                        (i < pKF->NLeft + pKF->NRight + pKF->NSideLeft) ?
                                        pKF->mvKeysSideLeft[i - pKF->NLeft - pKF->NRight].octave :
            ...
            int nObs = 0;
            for (map<KeyFrame*, tuple<int, int, int, int>>::const_iterator mit = observations.begin(),
                 ...
                 mit != mend; mit++)
            {
              ...
              else
              {
                ...
                if (sideleftIndex != -1)
                {
                  ...
                  scaleLeveli = (scaleLeveli == -1 || scaleLeveli > sideleftLevel) ? sideleftLevel : scaleLeveli;
                }

                if (siderightIndex != -1)
                {
                  int siderightLevel =
                      pKFi->mvKeysSideRight[siderightIndex - pKFi->NLeft - pKFi->NRight - pKFi->NSideLeft].octave;
                  scaleLeveli = (scaleLeveli == -1 || scaleLeveli > siderightLevel) ? siderightLevel : scaleLeveli;
                }
              }
