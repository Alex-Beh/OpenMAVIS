...
public:
  ...
  Sophus::SE3f GrabImageMulti(const cv::Mat& imRectLeft, const cv::Mat& imRectRight, const cv::Mat& imRectSideLeft,
                              const cv::Mat& imRectSideRight, const double& timestamp, string filename);
