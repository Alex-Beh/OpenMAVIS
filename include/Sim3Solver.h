...
public:
  ...
  Sim3Solver(KeyFrame* pKF1, KeyFrame* pKF2, const std::vector<MapPoint*>& vpMatched12, int& cameraID1, int& cameraID2,
             const bool bFixScale = true, const vector<KeyFrame*> vpKeyFrameMatchedMP = vector<KeyFrame*>());
